      ...
      <div className="space-y-8" data-testid="leaderboard-page">
        ...
        {userPosition > 0 && (
          <motion.div
            ...
            className="glass-card p-4 border-gold/30"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white font-bold text-xl">
                  #{userPosition} <span className="text-white/60 font-normal text-base">out of {leaderboard.length}</span>
                </p>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="p-4 border-b border-white/10">
            <h2 className="font-cinzel font-bold text-lg text-white">All Performers</h2>
          </div>
            ...
            {leaderboard.map((entry, index) => {
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-gold font-bold text-lg">{entry.points}</p>
        ...
        {leaderboard.length === 0 && (
          <div className="glass-card p-12 text-center">
            ...
            <p className="text-white/60 text-lg">No performers yet</p>
